...
**Spacelabs Healthcare**, working on the [Rothman Index](https://spacelabshealthcare.com/products/saas/predictive-analytics/)—an FDA-cleared predictive analytics system that spots patient deterioration before it becomes a crisis. It pulls from 26 data points in the EMR and gives clinicians a real-time picture of how sick someone actually is. The kind of work where getting it right matters.
...
- [GitHub](https://github.com/afspear)
- [LinkedIn](https://linkedin.com/in/afspear)
- [afspear@gmail.com](mailto:afspear@gmail.com)
- [BlueSky](https://bsky.app/profile/afspear.bsky.social)
---

<p style="opacity: 0.6; font-size: 0.9em;">Birmingham, Alabama</p>
